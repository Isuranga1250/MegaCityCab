...
@WebServlet("/GetCarDetails")
public class GetCarDetails extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            List<Car> allCars = CarService.getCarDetails();
            ...
            // Forward to Cars.jsp
            RequestDispatcher dis = request.getRequestDispatcher("Cars.jsp");
